		<div class="sidebar">
<?php global $options; $a3 = '<div class="widget">' . $options['sidebar_a3']['content'] . '</div>'; if ($options['sidebar_a3']['home'] && is_home()) echo $a3; if ($options['sidebar_a3']['single'] && is_single()) echo $a3; ?>
<?php dynamic_sidebar(); ?>
...
<?php endforeach; ?>
			...
			<div class="site-link">
				<div class="permalink">
					...
					<div class="bd">
						<ul class="clearfix">
<?php wp_list_bookmarks('limit=15&title_li=&categorize=0&category=2&category_before=&category_after=&before=<li>&after=</li>'); ?>
						</ul>
					</div>
				</div>
